...
import * as actionCreatoros from '../../store/actions/todo';
    ...
    return jest.fn(props => {
        return (
            <div className="spyTodo">
                <div className="title" onClick={props.clcikDetail}>
                    {props.title}
                </div>
...
const stubInitialState = {
    todos: [
        ...
        {id: 2, title: 'TODO_TEST_TITLE_1', done: false},
        {id: 3, title: 'TODO_TEST_TITLE_1', done: false},
    ],
    selectedTodo: null,
};
